...
void Adafruit_ILI9341_8bit_AS::begin(uint16_t id)
 {
  ...
  delay(200);
   ...
   uint16_t a, d;
   driver = ID_9341;
   Serial.print("Driver_ID: ");Serial.println(id, HEX); // put into cpp for dbug by A.Tedds
   CS_ACTIVE;
   writeRegister8(ILI9341_SOFTRESET, 0);
   Serial.print("addr: "); Serial.print(a, HEX); // put into cpp for dbug by A.Tedds
   Serial.print(" data: "); Serial.println(d, HEX);// put into cpp for dbug by A.Tedds
   delay(50);
